...
# -*- coding: utf-8 -*-
"""
Stereo Camera Real-Time Depth Mapping
    ...
    try:
        ...
        while True:
            ...
            if key == ord('x'):
                ...
                adjust_parameters(key, stereo_matcher, right_matcher, wls_filter)
...
def adjust_parameters(key, stereo_matcher, right_matcher, wls_filter):
    """
    ...
    if key == ord('q'):
        ...
        right_matcher.setBlockSize(block_size)
        ...
        num_disp = num_disp - num_disp % 16  # Ensure it's divisible by 16
