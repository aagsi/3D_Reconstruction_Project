...
class RealSense3DScanner:
    ...
    def capture_point_cloud(self):
        ...
        pcd_frame = pcd_frame_cuda.to_legacy()

        # Estimate normals for the captured frame
        pcd_frame.estimate_normals(search_param=o3d.geometry.KDTreeSearchParamHybrid(radius=0.05, max_nn=30))

        return pcd_frame

    def align_point_clouds(self, source, target, threshold=0.02):
        """
        Aligns two point clouds using the Generalized Iterative Closest Point (G-ICP) algorithm.
        The source point cloud is aligned to the target point cloud.
        ...
        while not stop_event.is_set():
            ...
            if pcd_frame and len(pcd_frame.points) > 0:
                ...
                if len(self.combined_pcd.points) == 0:
                    ...
                    self.combined_pcd.normals = pcd_frame.normals
                    ...
                    # Re-estimate normals for the combined point cloud
                    self.combined_pcd.estimate_normals(search_param=o3d.geometry.KDTreeSearchParamHybrid(radius=0.05, max_nn=30))
