...
class RealSense3DScanner:
    ...
    def scanning_loop(self, stop_event):
        ...
        point cloud, and processes them. This function runs in a separate thread.
    ...
    def save_point_cloud(self, filename="captured_data.ply"):
        """
    ...
    def process_point_cloud(self, filename="captured_data.ply"):
        """
    ...
    def run(self):
        ...
        It starts the RealSense camera, runs the scanning loop, processes the captured point cloud,
